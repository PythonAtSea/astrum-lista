...
Then, it'll be hosted at [http://localhost:3000](http://localhost:3000), assuming everything is set to the defaults. It's just a basic [Next.JS](https://nextjs.org/) project, not too hard to figure out. You can DM me on the Hack Club Slack @pythonatsea if you have any questions.
